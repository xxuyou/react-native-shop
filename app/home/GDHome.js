...
import HomeCell from './GDHomeCell';
...
export default class GDHome extends Component {
  ...
  static defaultProps = {
    fetchURI: 'http://guangdiu.com/api/getlist.php?country=cn',
  }
  fetchData() {
    this.setState({
      isRefreshing: true
  ...
  renderLeftItem() {
    return (
      <TouchableOpacity onPress={() => {this.pushToHalfHourHot()}} style={styles.topNavLeftViewStyle}>
        <Image source={{uri:'hot_icon_20x20'}}  style={styles.topNavLeftIconStyle} />
      </TouchableOpacity>
    )
  }
  renderCenterItem() {
    return (
      <TouchableOpacity>
        <Image source={{uri:'navtitle_home_down_66x20'}}  style={styles.topNavCenterIconStyle} />
      </TouchableOpacity>
    )
  }
  renderRightItem() {
