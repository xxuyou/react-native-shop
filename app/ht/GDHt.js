...
export default class GDHt extends Component {
  ...
  static defaultProps = {
    fetchURI: 'http://guangdiu.com/api/getlist.php?country=us',
  }
  fetchData() {
    this.setState({
      isRefreshing: true
  ...
  renderCenterItem() {
    return (
      <TouchableOpacity>
        <Image source={{uri:'navtitle_abroad_down_66x20'}}  style={styles.topNavCenterIconStyle} />
      </TouchableOpacity>
    )
  }
  renderRightItem() {
